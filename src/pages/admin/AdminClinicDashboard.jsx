        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage your clinic staff and operations</p>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {messages.length > 0 && (
          <div className="bg-white rounded-lg shadow mb-8 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <a href="/messages" className="text-blue-600 hover:text-blue-700">View all</a>
            </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-xl font-bold text-gray-900">Clinic Staff</h2>
          </div>
          <div className="p-6">
            {loading ? (
